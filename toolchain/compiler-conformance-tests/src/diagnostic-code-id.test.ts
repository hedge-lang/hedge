...
describe("diagnostic code ID conformance", (): void => {
  ...
  it.fails("emitted diagnostics expose a code field with schema-valid IDs", (): void => {
  ...
  it.fails("all diagnostics in the core error corpus include schema-valid code ids", (): void => {
    const corpus = [
      `fn main(`,
