...
export const CROSS_DOMAIN_CONFORMANCE_RULES: readonly ConformanceRule[] = [
  ...
  },
  {
    ...
    testIds: [
      ...
      "still rejects moving an element out of a fixed-size-array parameter typed with a declared generic parameter, since it is not provably Copy",
      "still rejects reusing a generic-typed value more than once in a fixed-size array literal, since it is not provably Copy",
      "still rejects a repeat-form array literal whose generic-typed value is not provably Copy",
    ],
  },
  {
    id: "DROP-DETERMINISM",
