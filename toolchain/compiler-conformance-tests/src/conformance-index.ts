...
export const CROSS_DOMAIN_CONFORMANCE_RULES: readonly ConformanceRule[] = [
  ...
  },
  {
    ...
    testIds: [
      ...
      "ambiguous two-parameter elision is rejected",
      "lifetime elision fills the return type from the sole reference parameter",
      "explicit lifetime annotations resolve what elision alone cannot",
      "a struct's own lifetime parameter parses and is stored on its reference field",
